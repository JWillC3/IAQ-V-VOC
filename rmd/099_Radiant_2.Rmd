...
## Data set
Small clinic in Eastern Colorado. Typically 5 - 15 staff on site with
1 - 2 patients every 1 - 2 hours.
Summa Canisters were deployed in 6 locations at the site:
...
```{r plot_all, fig.width = 16, fig.height = 9, warning=FALSE, message=FALSE}
...
All Locations
```{r facet_grid_voc_cat, fig.width = 16, fig.height = 9, warning=FALSE, message=FALSE}
...
Indoor locations
```{r facet_grid_indoor, fig.width = 16, fig.height = 9, warning=FALSE, message=FALSE}
...
grid.arrange(p_exam1_top, p_exam2_top, p_lobby_top, p_nurse_station_top,
             ...
             ncol = 3, nrow = 2,
             top = "Top 5 Analytes in Each Location", left = "Concentrations")
...
```{r ratio_plot, fig.width = 18, fig.height = 9, warning=FALSE, message=FALSE}
