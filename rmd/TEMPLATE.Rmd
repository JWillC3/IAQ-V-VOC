...
The location1 classroom is a first floor classroom for children ages 2-3 with
...
The location2 classroom is a first floor classroom for children ages 3-4 with
an average occupancy of about 12 children and 2 adults.
...
Lesson Prep is a second floor location5, teacher's lounge, and storage area. 
Occupancy was between 1 and 5 teachers with a max occupancy of 10.
```{r, location_3_photo, out.width="75%"}

include_graphics("../graphics/XXX_lessonprep.jpg")
...
The location4 classroom is a first floor classroom for children ages 1-2 with
...
The location5 location was a first floor location5 occupied by 3 teachers periodaclly
