...
#data table
site_066_table <- data_table(sites, "066")

site_dt(site_066_table, "066")

#box plot for all analytes
bp_066 <- box_plot(site_066)
bp_066

#plot all VOCs at site
p_066 <- p_site(site_066, "066")
p_066

#plotly output but y axis not formatted correctly and don't know how to fix
ggplotly(p_066, tooltip = "text")

#TVOC for site by room
p_066_sum <- p_conc_room(site_066, "066 [Site Name]")
p_066_sum

#top 10 analyte concentrations for all locations
site_066_top <- top_n_analytes(site_066, 45)

site_066_top <- top_plot(site_066_top, "066", fill = "darkgreen")
site_066_top

#facet wrap by location
p_066_fctw <- fct_wrap(site_066, "066")
p_066_fctw 

#facet wrap by indoor location
p_066i_fctw <- fct_wrap(indoor_066, "066")
p_066i_fctw 
...
#plots for each room
#outdoor
p_066outdoor <- room_plot(outdoor_066, "066", "midnightblue", "Outdoor, rooftop")
p_066outdoor

#location1
p_location1 <- room_plot(location1, "066", "orchid", "location_1, [floor] [room type]")
p_location1

#location2
p_location2 <- room_plot(location2, "066", "chocolate4", "location_2, [floor] [room type]")
p_location2

#location3
p_location3 <- room_plot(location3, "066", "goldenrod2", "location_3, [floor] [room type]")
p_location3

#location4
p_location4 <- room_plot(location4, "066", "#50c878", "location_4, [floor] [room type]")
p_location4

#location5
p_location5 <- room_plot(location5, "066", "tomato2", "location_5, [floor] [room type]")
p_location5

#all rooms
grid.arrange(p_location1, p_location2, p_location4, p_location3,
             p_location5, p_066outdoor, 
             ncol = 3,
...
#outdoor
outdoor_top <- top_n_analytes(outdoor_066, 10)
...
p_066_bp <- r_box_plot(indoor_066)
p_066_bp

#indoor to outdoor ratio plot for all analytes
p_066_ratio <- r_p_site(indoor_066, "066")
p_066_ratio

#plotly ratio
ggplotly(p_066_ratio, tooltip = "text")

#ratio plot with facet wrap
p_066_r_fctw <- r_fct_wrap(indoor_066, "066")
p_066_r_fctw

#create object of the top 10 analytes by outdoor ratio then plot
#location1 outdoor ratio
location1_top_or <- top_n_or(indoor_066, "location_1", 10)
...
location2_top_or <- top_n_or(indoor_066, "location_1", 10)
...
location3_top_or <- top_n_or(indoor_066, "location_3", 10)
...
location4_top_or <- top_n_or(indoor_066, "location_4", 10)
...
location5_top_or <- top_n_or(indoor_066, "location_5", 10)
...
p_066_cat_fctw <- cat_fct_wrap(site_066, "066 (All Locations)")
p_066_cat_fctw

#indoor facet wrap by analyte class
p_066i_cat_fctw <- cat_fct_wrap(indoor_066, "066 (Indoor Locations)")
p_066i_cat_fctw
...
p_category(p_alcohol, "066 ", "Alcohols")
p_alcohol
...
p_category(p_aldehyde, "066 ", "Aldehydes")
p_aldehyde
...
p_category(p_straight_chain, "066 ", "Straight Chains")
p_straight_chain
...
p_category(p_aromatic, "066 ", "Aromatics")
p_aromatic
...
p_category(p_chlorinated, "066 ", "Chlorinated")
p_chlorinated
...
p_category(p_ketone, "066 ", "Ketones")
p_ketone
