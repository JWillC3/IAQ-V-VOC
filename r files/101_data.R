...
#data table
site_101_table <- data_table(sites, "101")

site_dt(site_101_table, "101")

#box plot for all analytes
bp_101 <- box_plot(site_101)
bp_101

#plot all VOCs at site
p_101 <- p_site(site_101, "101")
p_101

#plotly output but y axis not formatted correctly and don't know how to fix
ggplotly(p_101, tooltip = "text")

#TVOC for site by room
p_101_sum <- p_conc_room(site_101, "101 [Site Name]")
p_101_sum

#top 10 analyte concentrations for all locations
site_101_top <- top_n_analytes(site_101, 45)

site_101_top <- top_plot(site_101_top, "101", fill = "darkgreen")
site_101_top

#facet wrap by location
p_101_fctw <- fct_wrap(site_101, "101")
p_101_fctw 

#facet wrap by indoor location
p_101i_fctw <- fct_wrap(indoor_101, "101")
p_101i_fctw 
...
#plots for each room
#outdoor
p_101outdoor <- room_plot(outdoor_101, "101", "midnightblue", "Outdoor, rooftop")
p_101outdoor

#location1
p_location1 <- room_plot(location1, "101", "orchid", "location_1, [floor] [room type]")
p_location1

#location2
p_location2 <- room_plot(location2, "101", "chocolate4", "location_2, [floor] [room type]")
p_location2

#location3
p_location3 <- room_plot(location3, "101", "goldenrod2", "location_3, [floor] [room type]")
p_location3

#location4
p_location4 <- room_plot(location4, "101", "#50c878", "location_4, [floor] [room type]")
p_location4

#location5
p_location5 <- room_plot(location5, "101", "tomato2", "location_5, [floor] [room type]")
p_location5

#all rooms
grid.arrange(p_location1, p_location2, p_location4, p_location3,
             p_location5, p_101outdoor, 
             ncol = 3,
...
#outdoor
outdoor_top <- top_n_analytes(outdoor_101, 10)
...
p_101_bp <- r_box_plot(indoor_101)
p_101_bp

#indoor to outdoor ratio plot for all analytes
p_101_ratio <- r_p_site(indoor_101, "101")
p_101_ratio

#plotly ratio
ggplotly(p_101_ratio, tooltip = "text")

#ratio plot with facet wrap
p_101_r_fctw <- r_fct_wrap(indoor_101, "101")
p_101_r_fctw

#create object of the top 10 analytes by outdoor ratio then plot
#location1 outdoor ratio
location1_top_or <- top_n_or(indoor_101, "location_1", 10)
...
location2_top_or <- top_n_or(indoor_101, "location_1", 10)
...
location3_top_or <- top_n_or(indoor_101, "location_3", 10)
...
location4_top_or <- top_n_or(indoor_101, "location_4", 10)
...
location5_top_or <- top_n_or(indoor_101, "location_5", 10)
...
p_101_cat_fctw <- cat_fct_wrap(site_101, "101 (All Locations)")
p_101_cat_fctw

#indoor facet wrap by analyte class
p_101i_cat_fctw <- cat_fct_wrap(indoor_101, "101 (Indoor Locations)")
p_101i_cat_fctw
...
p_category(p_alcohol, "101 ", "Alcohols")
p_alcohol
...
p_category(p_aldehyde, "101 ", "Aldehydes")
p_aldehyde
...
p_category(p_straight_chain, "101 ", "Straight Chains")
p_straight_chain
...
p_category(p_aromatic, "101 ", "Aromatics")
p_aromatic
...
p_category(p_chlorinated, "101 ", "Chlorinated")
p_chlorinated
...
p_category(p_ketone, "101 ", "Ketones")
p_ketone
