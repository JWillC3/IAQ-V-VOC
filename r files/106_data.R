...
#data table
site_106_table <- data_table(sites, "106")

site_dt(site_106_table, "106")

#box plot for all analytes
bp_106 <- box_plot(site_106)
bp_106
...
ggplotly(p_106, tooltip = "text")

#TVOC for site by room
p_106_sum <- p_conc_room(site_106, "106 [Site Name]")
p_106_sum

#top 10 analyte concentrations for all locations
site_106_top <- top_n_analytes(site_106, 45)

site_106_top <- top_plot(site_106_top, "106", fill = "darkgreen")
site_106_top

#facet wrap by location
p_106_fctw <- fct_wrap(site_106, "106")
p_106_fctw 

#facet wrap by indoor location
p_106i_fctw <- fct_wrap(indoor_106, "106")
p_106i_fctw 
...
#plots for each room
#outdoor
p_106outdoor <- room_plot(outdoor_106, "106", "midnightblue", "Outdoor, rooftop")
p_106outdoor

#location1
p_location1 <- room_plot(location1, "106", "orchid", "location_1, [floor] [room type]")
p_location1

#location2
p_location2 <- room_plot(location2, "106", "chocolate4", "location_2, [floor] [room type]")
p_location2

#location3
p_location3 <- room_plot(location3, "106", "goldenrod2", "location_3, [floor] [room type]")
p_location3

#location4
p_location4 <- room_plot(location4, "106", "#50c878", "location_4, [floor] [room type]")
p_location4

#location5
p_location5 <- room_plot(location5, "106", "tomato2", "location_5, [floor] [room type]")
p_location5

#all rooms
grid.arrange(p_location1, p_location2, p_location4, p_location3,
             p_location5, p_106outdoor, 
             ncol = 3,
...
#outdoor
outdoor_top <- top_n_analytes(outdoor_106, 10)
...
p_106_bp <- r_box_plot(indoor_106)
p_106_bp

#indoor to outdoor ratio plot for all analytes
p_106_ratio <- r_p_site(indoor_106, "106")
p_106_ratio

#plotly ratio
ggplotly(p_106_ratio, tooltip = "text")

#ratio plot with facet wrap
p_106_r_fctw <- r_fct_wrap(indoor_106, "106")
p_106_r_fctw

#create object of the top 10 analytes by outdoor ratio then plot
#location1 outdoor ratio
location1_top_or <- top_n_or(indoor_106, "location_1", 10)
...
location2_top_or <- top_n_or(indoor_106, "location_1", 10)
...
location3_top_or <- top_n_or(indoor_106, "location_3", 10)
...
location4_top_or <- top_n_or(indoor_106, "location_4", 10)
...
location5_top_or <- top_n_or(indoor_106, "location_5", 10)
...
p_106_cat_fctw <- cat_fct_wrap(site_106, "106 (All Locations)")
p_106_cat_fctw

#indoor facet wrap by analyte class
p_106i_cat_fctw <- cat_fct_wrap(indoor_106, "106 (Indoor Locations)")
p_106i_cat_fctw
...
p_category(p_alcohol, "106 ", "Alcohols")
p_alcohol
...
p_category(p_aldehyde, "106 ", "Aldehydes")
p_aldehyde
...
p_category(p_straight_chain, "106 ", "Straight Chains")
p_straight_chain
...
p_category(p_aromatic, "106 ", "Aromatics")
p_aromatic
...
p_category(p_chlorinated, "106 ", "Chlorinated")
p_chlorinated
...
p_category(p_ketone, "106 ", "Ketones")
p_ketone
