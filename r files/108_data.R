...
#data table
site_108_table <- data_table(sites, "108")

site_dt(site_108_table, "108")

#box plot for all analytes
bp_108 <- box_plot(site_108)
bp_108

#plot all VOCs at site
p_108 <- p_site(site_108, "108")
p_108

#plotly output but y axis not formatted correctly and don't know how to fix
ggplotly(p_108, tooltip = "text")

#TVOC for site by room
p_108_sum <- p_conc_room(site_108, "108 [Site Name]")
p_108_sum

#top 10 analyte concentrations for all locations
site_108_top <- top_n_analytes(site_108, 45)

site_108_top <- top_plot(site_108_top, "108", fill = "darkgreen")
site_108_top

#facet wrap by location
p_108_fctw <- fct_wrap(site_108, "108")
p_108_fctw 

#facet wrap by indoor location
p_108i_fctw <- fct_wrap(indoor_108, "108")
p_108i_fctw 
...
#plots for each room
#outdoor
p_108outdoor <- room_plot(outdoor_108, "108", "midnightblue", "Outdoor, rooftop")
p_108outdoor

#location1
p_location1 <- room_plot(location1, "108", "orchid", "location_1, [floor] [room type]")
p_location1

#location2
p_location2 <- room_plot(location2, "108", "chocolate4", "location_2, [floor] [room type]")
p_location2

#location3
p_location3 <- room_plot(location3, "108", "goldenrod2", "location_3, [floor] [room type]")
p_location3

#location4
p_location4 <- room_plot(location4, "108", "#50c878", "location_4, [floor] [room type]")
p_location4

#location5
p_location5 <- room_plot(location5, "108", "tomato2", "location_5, [floor] [room type]")
p_location5

#all rooms
grid.arrange(p_location1, p_location2, p_location4, p_location3,
             p_location5, p_108outdoor, 
             ncol = 3,
...
#outdoor
outdoor_top <- top_n_analytes(outdoor_108, 10)
...
p_108_bp <- r_box_plot(indoor_108)
p_108_bp

#indoor to outdoor ratio plot for all analytes
p_108_ratio <- r_p_site(indoor_108, "108")
p_108_ratio

#plotly ratio
ggplotly(p_108_ratio, tooltip = "text")

#ratio plot with facet wrap
p_108_r_fctw <- r_fct_wrap(indoor_108, "108")
p_108_r_fctw

#create object of the top 10 analytes by outdoor ratio then plot
#location1 outdoor ratio
location1_top_or <- top_n_or(indoor_108, "location_1", 10)
...
location2_top_or <- top_n_or(indoor_108, "location_1", 10)
...
location3_top_or <- top_n_or(indoor_108, "location_3", 10)
...
location4_top_or <- top_n_or(indoor_108, "location_4", 10)
...
location5_top_or <- top_n_or(indoor_108, "location_5", 10)
...
p_108_cat_fctw <- cat_fct_wrap(site_108, "108 (All Locations)")
p_108_cat_fctw

#indoor facet wrap by analyte class
p_108i_cat_fctw <- cat_fct_wrap(indoor_108, "108 (Indoor Locations)")
p_108i_cat_fctw
...
p_category(p_alcohol, "108 ", "Alcohols")
p_alcohol
...
p_category(p_aldehyde, "108 ", "Aldehydes")
p_aldehyde
...
p_category(p_straight_chain, "108 ", "Straight Chains")
p_straight_chain
...
p_category(p_aromatic, "108 ", "Aromatics")
p_aromatic
...
p_category(p_chlorinated, "108 ", "Chlorinated")
p_chlorinated
...
p_category(p_ketone, "108 ", "Ketones")
p_ketone
